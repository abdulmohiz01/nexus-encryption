...
const About = () => {
  return (
    <>
      ...
      <div className="text-white p-6 rounded-lg shadow-md mt-10 mx-auto max-w-3xl">
        ...
        <div className="flex flex-col items-center mb-6">
          <img src="/avatar.png" alt="Abdul Mohiz" className="w-[250px] h-[250px] rounded-full mb-2" />
